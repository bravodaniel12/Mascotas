    ...
    useEffect(() => {
        const fetchPetData = async () => {
            try {
                ...
                const imgPath = `http://localhost:3000/img/${petData.foto}`;
                const uploadsPath = `http://localhost:3000/uploads/${petData.foto}`;
